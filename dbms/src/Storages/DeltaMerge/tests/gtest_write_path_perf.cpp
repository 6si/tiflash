...
// =============================================================================
// Parallel Column Serialization Benchmarks
// =============================================================================

class WritePathSerializationPerfTest : public ::testing::Test
{
protected:
...
TEST_F(WritePathSerializationPerfTest, SerializeColumnsSequential)
{
...
TEST_F(WritePathSerializationPerfTest, SerializeColumnsParallel)
{
    const size_t num_rows = 8192;
    const size_t num_string_cols = 5;
    const size_t string_size = 512;
...
TEST_F(WritePathSerializationPerfTest, SerializeLargeJsonSequentialVsParallel)
{
    const size_t num_rows = 8192;
...
TEST_F(WritePathSerializationPerfTest, EndToEndWriteSequentialVsParallel)
{
    const size_t num_rows = 8192;
    const size_t num_string_cols = 8;
